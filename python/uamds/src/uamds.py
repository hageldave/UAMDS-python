...
def gradient(normal_distr_spec: np.ndarray, uamds_transforms: np.ndarray, precalc_constants: tuple) -> tuple[
...
def main():
    ...
    uamds_transforms = iterate_simple_gradient_descent(normal_distr_spec, uamds_transforms, constants, a=0.000001)
    print(stress(normal_distr_spec, uamds_transforms, constants))
    uamds_transforms = iterate_simple_gradient_descent(normal_distr_spec, uamds_transforms, constants, num_iter=100,
                                                       a=0.000001)
    print(stress(normal_distr_spec, uamds_transforms, constants))
